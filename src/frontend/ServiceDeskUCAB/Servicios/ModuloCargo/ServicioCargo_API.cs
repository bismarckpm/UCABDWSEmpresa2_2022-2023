...
namespace ServiceDeskUCAB.Servicios.ModuloCargo
{
    public class ServicioCargo_API : IServicioCargo_API
    {
        ...
        public async Task<Tuple<List<CargoDto>, List<Tipo_CargoDto>>> ListaCargoTipoCargo()
        {
            List<CargoDto> listaCargo = new List<CargoDto>();
            List<Tipo_CargoDto> listaTipo = new List<Tipo_CargoDto>();
            ...
            try
            {
                ...
                if (responseCargo.IsSuccessStatusCode && responseTipo.IsSuccessStatusCode)
                {
                    ...
                    var resultadoCargo = JsonConvert.DeserializeObject<List<CargoDto>>(stringDataRespuestaCargo);

                    //Obtengo la data del json respuesta Grupo
                    string stringDataRespuestaTipo = json_respuestaTipo["data"].ToString();
                    var resultadoTipo = JsonConvert.DeserializeObject<List<Tipo_CargoDto>>(stringDataRespuestaTipo);
            ...
            var tupla = new Tuple<List<CargoDto>, List<Tipo_CargoDto>>(listaCargo, listaTipo);
        ...
        public async Task<JObject> RegistarCargo(CargoDto cargo)
        {
            HttpClient cliente = new()
            {
                BaseAddress = new Uri(_baseUrl)
        ...
        public async Task<JObject> EditarCargo(CargoDto_Update cargo)
        {
            HttpClient cliente = new()
            {
                BaseAddress = new Uri(_baseUrl)
