    ...
    public partial class InitialCommit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Familia_Ticket", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tipo_Estado_PlantillaNotificacion_PlantillaNotificacionId",
                        column: x => x.PlantillaNotificacionId,
                        principalTable: "PlantillaNotificacion",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_Familia_Ticket_Familia_TicketId",
                        column: x => x.Familia_TicketId,
                        principalTable: "Familia_Ticket",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bitacora_Ticket", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Bitacora_Ticket_Estados_EstadoId",
                        column: x => x.EstadoId,
                        principalTable: "Estados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bitacora_Ticket_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bitacora_Ticket_EstadoId",
                table: "Bitacora_Ticket",
                column: "EstadoId");

            migrationBuilder.CreateIndex(
                name: "IX_Bitacora_Ticket_TicketId",
                table: "Bitacora_Ticket",
                column: "TicketId");
