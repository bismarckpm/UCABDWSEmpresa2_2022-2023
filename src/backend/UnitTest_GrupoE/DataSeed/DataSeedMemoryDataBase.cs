...
{
    public static class DataSeedMemoryDataBase
    {

        public static DataContext SetupDbContextData(this DataContext _mockContext)
        {
            ...
            //_mockContext.SetupGet(c => c.Tipos_Estados).Returns(ListaTipoEstados.AsQueryable().BuildMockDbSet().Object);
            ...
            //_mockContext.Setup(c => c.Prioridades).Returns(ListaPrioridad.AsQueryable().BuildMockDbSet<Prioridad>().Object);
            //_mockContext.SetupGet(c => c.Prioridades).Returns(ListaPrioridad.AsQueryable().BuildMockDbSet().Object);
            ...
            List<Empleado> ListaUsuario = new List<Empleado>
            {
                //Jefes D1
            ...
            _mockContext.Empleados.AddRange(ListaUsuario);
            ...
            var ListaFlujoAprobacion = new List<Flujo_Aprobacion>
            {
                ...
                new Flujo_Aprobacion(ListaTipoTickets[2].Id,ListaTipoCargo[1].Id, 2,1,1)
                {
                    Tipo_Ticket = ListaTipoTickets[2],
                    Tipo_Cargo = ListaTipoCargo[1]
                },
                new Flujo_Aprobacion(ListaTipoTickets[2].Id,ListaTipoCargo[2].Id, 1,1,1)
                {
                    Tipo_Ticket = ListaTipoTickets[2],
                    Tipo_Cargo = ListaTipoCargo[2]
                }
